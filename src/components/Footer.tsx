      ...
      <div className="mx-auto max-w-[1400px] px-5 py-16 sm:px-8 sm:py-20">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)_minmax(0,1fr)]">
          <div>
            ...
            <p className="mt-5 max-w-sm text-[14px] leading-relaxed text-paper/45">
              A student-run society at Wilfrid Laurier University. Not affiliated with any employer listed;
              all figures self-reported from our event logs.
            </p>
          </div>
